    ...
    return [
        DatasetSpec(
            ...
            queries=[
                ...
                QuerySpec("and_status_plan", ["account_id"], ["status_code", "=", "2", "AND", "plan_tier", "=", "3"], [[("bitmap", "status_code"), ("bitmap", "plan_tier")]], "AND"),
        ...
        DatasetSpec(
            ...
            queries=[
                ...
                QuerySpec("and_warehouse_aisle", ["inventory_id"], ["warehouse_id", "=", "100", "AND", "aisle_id", "=", "1"], [[("rle", "warehouse_id"), ("rle", "aisle_id")]], "AND"),
        ...
        DatasetSpec(
            ...
            queries=[
                ...
                QuerySpec("and_status_hub", ["shipment_event_id"], ["status_code", "=", "3", "AND", "hub_id", "=", "204"], [[("bitmap", "status_code"), ("bitmap", "hub_id")]], "AND"),
